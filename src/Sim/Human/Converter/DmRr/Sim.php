...
use OpenDominion\Sim\Human\Converter\DmRr\BuildingStrategy;
use OpenDominion\Sim\Human\Converter\DmRr\TrainingStrategy;
use OpenDominion\Sim\Human\Converter\DmRr\ImprovementStrategy;
...
class Sim extends Base
{
  ...
  function destroy($tick) {
    try {
      if($tick == 480) {
        $result = $this->destroyActionService->destroy($this->dominion, ['alchemy' => 182]);
        print "tick $tick: destroyed 182 alchs alchs<br />";
      }
