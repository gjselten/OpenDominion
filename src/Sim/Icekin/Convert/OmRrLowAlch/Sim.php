...
namespace OpenDominion\Sim\Icekin\Convert\OmRrLowAlch;

use OpenDominion\Models\User;
use OpenDominion\Models\Dominion;

use OpenDominion\Sim\Base;
use OpenDominion\Sim\Icekin\Convert\OmRrLowAlch\BuildingStrategy;
use OpenDominion\Sim\Icekin\Convert\OmRrLowAlch\TrainingStrategy;
use OpenDominion\Sim\Icekin\Convert\OmRrLowAlch\ImprovementStrategy;
...
class Sim extends Base
{
  ...
  function createOopDom() {
    ...
    return Dominion::create([
      ...
      'building_home' => 30,
      'building_alchemy' => 195,
      'building_farm' => 20,
      'building_smithy' => 142,
      'building_masonry' => 0,
      'building_ore_mine' => 308,
