...
use OpenDominion\Sim\Icekin\Convert\Actual\BuildingStrategy;
use OpenDominion\Sim\Icekin\Convert\Actual\TrainingStrategy;
use OpenDominion\Sim\Icekin\Convert\Actual\ImprovementStrategy;
...
class Sim extends Base
{
  ...
  function createOopDom() {
    ...
    return Dominion::create([
      ...
      'resource_platinum' => 1200000,
      'resource_food' => 170000,
      ...
      'improvement_science' => 6000000,
      'improvement_keep' => 17300000,
      'improvement_towers' => 0,
      'improvement_forges' => 0,
      'improvement_walls' => 9200000,
      'improvement_harbor' => 0,

      'military_draftees' => 944,
      'military_unit1' => 0,
      'military_unit2' => 840,
      'military_unit3' => 23750,
      'military_unit4' => 0,
      'military_spies' => 869,
      'military_wizards' => 1700,
      'military_archmages' => 380,
      ...
      'building_home' => 801,
      'building_alchemy' => 237,
      'building_farm' => 51,
      'building_smithy' => 544,
      'building_masonry' => 0,
      'building_ore_mine' => 950,
